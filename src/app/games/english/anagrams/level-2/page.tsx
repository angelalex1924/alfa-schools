...
// English anagram words for Level 2 (Intermediate)
const anagramWords = [
  { word: "elephant", hint: "Large animal with a trunk", scrambled: "hantelpe" },
  { word: "computer", hint: "Electronic device for work", scrambled: "moputerc" },
  { word: "butterfly", hint: "Colorful flying insect", scrambled: "flyturebt" },
  { word: "mountain", hint: "Very high land formation", scrambled: "naintoum" },
  { word: "hospital", hint: "Place where doctors work", scrambled: "pitalsoh" },
  { word: "birthday", hint: "Annual celebration of birth", scrambled: "daybirth" },
  { word: "kitchen", hint: "Room where food is cooked", scrambled: "hctneki" },
  { word: "garden", hint: "Outdoor space with plants", scrambled: "dragen" },
  { word: "teacher", hint: "Person who educates students", scrambled: "hctaere" },
  { word: "library", hint: "Place with many books", scrambled: "rylibra" },
  { word: "weather", hint: "Condition of the atmosphere", scrambled: "eatherw" },
  { word: "morning", hint: "Early part of the day", scrambled: "gninrom" },
  { word: "evening", hint: "Late part of the day", scrambled: "gnineve" },
  { word: "picture", hint: "Visual representation or photo", scrambled: "turepic" },
  { word: "holiday", hint: "Day of celebration or rest", scrambled: "yadliho" },
  { word: "winter", hint: "Coldest season of the year", scrambled: "retniw" },
  { word: "summer", hint: "Hottest season of the year", scrambled: "remmus" },
  { word: "autumn", hint: "Season with falling leaves", scrambled: "nmutua" },
  { word: "spring", hint: "Season when flowers bloom", scrambled: "gnirps" },
  { word: "family", hint: "Group of related people", scrambled: "yilmaf" }
]
...
export default function EnglishAnagramsLevel2() {
  const { t } = useLanguage()
            ...
            <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className={cn(
                  ...
                  Unscramble longer words with hints
                </p>
              </div>
            </div>
