...
// English anagram words for Level 1 (Basic)
const anagramWords = [
  { word: "cat", hint: "A small furry pet that meows", scrambled: "tac" },
  { word: "dog", hint: "A loyal pet that barks", scrambled: "god" },
  { word: "sun", hint: "The bright star in our sky", scrambled: "nus" },
  { word: "moon", hint: "Shines at night in the sky", scrambled: "nomo" },
  { word: "book", hint: "You read this to learn", scrambled: "kobo" },
  { word: "tree", hint: "Tall plant with leaves", scrambled: "eert" },
  { word: "house", hint: "Where people live", scrambled: "esuoh" },
  { word: "car", hint: "Vehicle with four wheels", scrambled: "rac" },
  { word: "bird", hint: "Animal that can fly", scrambled: "drib" },
  { word: "fish", hint: "Lives in water and swims", scrambled: "hsif" },
  { word: "apple", hint: "Red or green fruit", scrambled: "elppa" },
  { word: "water", hint: "Clear liquid we drink", scrambled: "retaw" },
  { word: "fire", hint: "Hot and bright flames", scrambled: "erif" },
  { word: "star", hint: "Twinkles in the night sky", scrambled: "rats" },
  { word: "heart", hint: "Pumps blood in your body", scrambled: "traeh" },
  { word: "smile", hint: "Happy expression on face", scrambled: "elims" },
  { word: "hand", hint: "Has five fingers", scrambled: "dnah" },
  { word: "eye", hint: "You see with this", scrambled: "eye" },
  { word: "ball", hint: "Round object for playing", scrambled: "llab" },
  { word: "flower", hint: "Beautiful plant with petals", scrambled: "rewolf" }
]
...
export default function EnglishAnagramsLevel1() {
  const { t } = useLanguage()
