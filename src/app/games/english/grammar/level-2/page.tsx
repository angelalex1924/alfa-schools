...
const grammarQuestions = [
  ...
  {
    id: 2,
    question: "Complete: 'She has been working here _____ 2020.'",
  ...
  {
    id: 3,
    question: "Which is correct: 'I wish I _____ more time.'",
  ...
  {
    id: 4,
    question: "Choose: 'The book _____ by millions of people.'",
    options: ["is read", "was read", "has been read", "will be read"],
    correct: "has been read",
    explanation: "Present perfect passive for ongoing action",
    category: "Passive Voice"
  },
  {
    id: 5,
    question: "Complete: 'He suggested _____ to the cinema.'",
    options: ["go", "going", "to go", "we go"],
    correct: "going",
    explanation: "Suggest + gerund (verb + ing)",
    category: "Gerunds"
  },
  {
    id: 6,
    question: "Which is correct: 'I'm used to _____ early.'",
    options: ["get up", "getting up", "got up", "gets up"],
    correct: "getting up",
    explanation: "Be used to + gerund for habits",
    category: "Used to"
  },
  {
    id: 7,
    question: "Choose: 'The meeting _____ at 3 PM tomorrow.'",
    options: ["starts", "will start", "is starting", "is going to start"],
    correct: "is starting",
    explanation: "Present continuous for scheduled future events",
    category: "Future Tenses"
  },
  {
    id: 8,
    question: "Complete: 'I would rather _____ at home tonight.'",
  ...
  {
    id: 9,
    question: "Which is correct: 'The weather _____ worse.'",
    options: ["is getting", "gets", "will get", "got"],
    correct: "is getting",
    explanation: "Present continuous for gradual changes",
    category: "Present Continuous"
  },
  {
    id: 10,
    question: "Choose: 'She _____ her homework when I called.'",
  ...
  {
    id: 12,
    question: "Which is correct: 'The house _____ built last year.'",
    options: ["was", "is", "has been", "will be"],
    correct: "was",
    explanation: "Past simple passive for completed action",
    category: "Passive Voice"
  },
  {
    id: 13,
    question: "Choose: 'I can't help _____ about it.'",
    options: ["think", "thinking", "to think", "thought"],
    correct: "thinking",
    explanation: "Can't help + gerund (can't avoid doing)",
    category: "Gerunds"
  },
  {
    id: 14,
    question: "Complete: 'If I _____ the lottery, I would travel the world.'",
  ...
  {
    id: 15,
    question: "Which is correct: 'The letter _____ yesterday.'",
  ...
  {
    id: 16,
    question: "Choose: 'I'm looking forward to _____ you.'",
  ...
  {
    id: 17,
    question: "Complete: 'She _____ her keys since yesterday.'",
    options: ["lost", "has lost", "was losing", "loses"],
    correct: "has lost",
    explanation: "Present perfect for action with present result",
    category: "Present Perfect"
  },
  {
    id: 18,
    question: "Which is correct: 'The work _____ by tomorrow.'",
    options: ["finishes", "will finish", "will be finished", "is finishing"],
    correct: "will be finished",
    explanation: "Future passive for action completed by future time",
    category: "Passive Voice"
  },
  {
    id: 19,
    question: "Choose: 'I regret _____ you the truth.'",
    options: ["tell", "telling", "to tell", "told"],
    correct: "telling",
    explanation: "Regret + gerund for past action",
    category: "Gerunds"
  },
  {
    id: 20,
    question: "Complete: 'If I _____ harder, I would have passed.'",
...
export default function EnglishGrammarLevel2Page() {
  const { t } = useLanguage()
            ...
            <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className={cn(
                  ...
                  Master intermediate grammar rules
                </p>
              </div>
            </div>
