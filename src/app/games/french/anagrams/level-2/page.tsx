...
// French anagram words for Level 2 (Intermediate)
const anagramWords = [
  { word: "éléphant", hint: "Grand animal avec une trompe", scrambled: "hantelé" },
  { word: "ordinateur", hint: "Appareil électronique pour le travail", scrambled: "moputerc" },
  { word: "papillon", hint: "Insecte volant coloré", scrambled: "llonpapi" },
  { word: "montagne", hint: "Très haute formation terrestre", scrambled: "naintoum" },
  { word: "hôpital", hint: "Endroit où travaillent les médecins", scrambled: "pitalhô" },
  { word: "anniversaire", hint: "Célébration annuelle de naissance", scrambled: "daybirth" },
  { word: "cuisine", hint: "Pièce où la nourriture est cuite", scrambled: "hctneki" },
  { word: "jardin", hint: "Espace extérieur avec des plantes", scrambled: "dragen" },
  { word: "professeur", hint: "Personne qui éduque les étudiants", scrambled: "hctaere" },
  { word: "bibliothèque", hint: "Endroit avec beaucoup de livres", scrambled: "rylibra" },
  { word: "météo", hint: "Condition de l'atmosphère", scrambled: "eatherw" },
  { word: "matin", hint: "Partie précoce de la journée", scrambled: "gninrom" },
  { word: "soirée", hint: "Partie tardive de la journée", scrambled: "gnineve" },
  { word: "image", hint: "Représentation visuelle ou photo", scrambled: "turepic" },
  { word: "vacances", hint: "Jour de célébration ou de repos", scrambled: "yadliho" },
  { word: "hiver", hint: "Saison la plus froide de l'année", scrambled: "retniw" },
  { word: "été", hint: "Saison la plus chaude de l'année", scrambled: "remmus" },
  { word: "automne", hint: "Saison avec des feuilles qui tombent", scrambled: "nmutua" },
  { word: "printemps", hint: "Saison où les fleurs fleurissent", scrambled: "gnirps" },
  { word: "famille", hint: "Groupe de personnes apparentées", scrambled: "yilmaf" }
]
...
export default function FrenchAnagramsLevel2() {
  const { t } = useLanguage()
            ...
            <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className={cn(
                  ...
                  Mélangez des mots plus longs avec des indices
                </p>
              </div>
            </div>
                ...
                <div className="flex justify-center gap-1 sm:gap-2 mb-4 flex-wrap">
                  {scrambledWord.split('').map((letter, index) => (
                    <motion.div
                      ...
                      className={cn(
                        "w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center text-lg sm:text-xl font-bold",
