...
// French anagram words for Level 3 (Advanced)
const anagramWords = [
  { word: "aventure", hint: "Voyage ou expérience passionnante", scrambled: "tureadnev" },
  { word: "magnifique", hint: "Très attrayant ou agréable", scrambled: "lufituabe" },
  { word: "chocolat", hint: "Friandise sucrée à base de cacao", scrambled: "latechoco" },
  { word: "éducation", hint: "Processus d'apprentissage et d'enseignement", scrambled: "noitacude" },
  { word: "fantastique", hint: "Extraordinairement bon ou impressionnant", scrambled: "citsatnaf" },
  { word: "géographie", hint: "Étude des caractéristiques physiques de la Terre", scrambled: "ypargheog" },
  { word: "bonheur", hint: "Sentiment de joie et de contentement", scrambled: "ssenippah" },
  { word: "important", hint: "Ayant une grande signification ou valeur", scrambled: "tnatropmi" },
  { word: "connaissance", hint: "Information et compréhension", scrambled: "egdelwonk" },
  { word: "paysage", hint: "Caractéristiques visibles d'une zone", scrambled: "epacsknal" },
  { word: "montagne", hint: "Grande élévation naturelle de terre", scrambled: "naintoum" },
  { word: "nécessaire", hint: "Requis ou essentiel", scrambled: "yrassecen" },
  { word: "opération", hint: "Processus de fonctionnement", scrambled: "noitarepo" },
  { word: "paragraphe", hint: "Section distincte d'écriture", scrambled: "hpargarap" },
  { word: "question", hint: "Phrase qui demande des informations", scrambled: "noitseuq" },
  { word: "restaurant", hint: "Endroit où les repas sont servis", scrambled: "tnuaratser" },
  { word: "scientifique", hint: "Personne qui étudie la science", scrambled: "tsitneics" },
  { word: "téléphone", hint: "Appareil de communication vocale", scrambled: "enohpelet" },
  { word: "parapluie", hint: "Appareil de protection contre la pluie", scrambled: "llabremu" },
  { word: "bénévole", hint: "Personne qui offre de l'aide gratuitement", scrambled: "reteunlov" }
]
...
export default function FrenchAnagramsLevel3() {
  const { t } = useLanguage()
            ...
            <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className={cn(
                  ...
                  Défiez-vous avec des mots complexes
                </p>
              </div>
            </div>
