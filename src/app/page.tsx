  ...
  return (
    ...
    >
      ...
      <section
        ...
        style={{ background: `linear-gradient(135deg, #4a6fa5 0%, #81a1d4 100%)` }}
      >
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 text-center">
            {[
              { number: "35+", label: "Χρόνια Εμπειρίας", icon: "🏆" },
              { number: "1000+", label: "Επιτυχημένοι Μαθητές", icon: "👥" },
              { number: "15+", label: "Γλώσσες", icon: "📚" },
              { number: "95%", label: "Επιτυχία", icon: "📈" },
            ].map((stat, index) => (
              <div key={index} className="group">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 lg:p-6 transition-all duration-300 hover:scale-105 hover:bg-white/20 border border-white/20">
                  ...
                  <div className="text-2xl lg:text-4xl font-bold mb-2 text-white">{stat.number}</div>
      ...
      {/* Services Section */}
      <section className="relative z-10 py-16 lg:py-24 bg-gradient-to-b from-gray-50 to-orange-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold mb-6 text-gray-800">Οι Υπηρεσίες μας</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            {[
              ...
              <div
                key={index}
                className="group bg-white rounded-2xl lg:rounded-3xl p-6 lg:p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border hover:scale-105"
                style={{ borderColor: service.color, borderWidth: "1px" }}
              >
                <div className="text-4xl lg:text-5xl mb-4 lg:mb-6">{service.icon}</div>
                <h3 className="text-xl lg:text-2xl font-bold mb-3 lg:mb-4 text-gray-800">{service.title}</h3>
