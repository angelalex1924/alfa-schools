...
export function CookieSettingsButton({ language }: CookieSettingsButtonProps) {
  ...
  return (
    <button
      ...
      className="group relative flex items-center justify-center px-3 py-1 border border-amber-500 dark:border-amber-400 text-amber-700 dark:text-amber-300 bg-transparent font-medium rounded-full transition-all duration-200 hover:border-amber-600 hover:text-amber-800 dark:hover:border-amber-300 dark:hover:text-amber-100 text-xs shadow-none min-w-[120px]"
      style={{ minHeight: 0 }}
    >
      <svg 
        viewBox="0 0 64 64" 
        xmlns="http://www.w3.org/2000/svg" 
        className="w-4 h-4 inline-block align-middle flex-shrink-0 mr-1"
        aria-hidden="true" 
        role="img" 
